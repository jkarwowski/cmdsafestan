...
help:
	...
	@echo '    1. Install the Stan compiler bin/stanc$(EXE) from stanc3 binaries or STANC3.'
...
ifeq ($(OS),Windows_NT)
	...
	@echo ''
	@echo '    This target will:'
	@echo '    1. Install the Stan compiler (bin/stanc), as needed, from release binaries or STANC3.'
	...
	@echo '    STANC3: path to a local stanc3 checkout to build bin/stanc$(EXE) from source.'
